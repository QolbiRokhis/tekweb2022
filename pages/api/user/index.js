...
handler.patch(
  ...
  validateBody({
    ...
    properties: {
      ...
      birth: ValidateProps.user.birth,
      facebook: ValidateProps.user.facebook,
      github: ValidateProps.user.github,
    },
  ...
  async (req, res) => {
    ...
    const { name, bio, birth, facebook, github } = req.body;
    ...
    const user = await updateUserById(db, req.user._id, {
      ...
      ...(typeof facebook === 'string' && { facebook }),
